...
class ArquivosController extends Controller
{
   public function index(){
       return view('events.index')->with('arquivs',Arquivos::get());
   }
   ...
   public function store(Request $request){
       ...
       if(is_null($request->input('nome'))){
           $arquivo->nome = str_replace('.'.$request->arquivo->extension(),
       ...
       return back()->with('message',"Uplaod do arquivo '{$arquivo->nome}' realizado com sucesso.");
